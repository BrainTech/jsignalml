    ...
    extends Signalml
{
        ...
        extends Signalml.FileClass
    {
        ...
        public void createParams() {
            ...
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:1)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:485)
                    ...
                    extends OuterLoopClass.LoopClass
                {
                        ...
                        extends Param<TypeString>
                    {
                        ...
                        public String id() {
                            // jsignalml.ASTNode$XmlParam._accept(ASTNode.java:247)
                            // jsignalml.JavaClassGen.visit(JavaClassGen.java:1)
                            // jsignalml.JavaClassGen.visit(JavaClassGen.java:486)
                            // jsignalml.JavaClassGen.idMethod(JavaClassGen.java:522)
                        ...
                        protected TypeString _get() {
                            // jsignalml.ASTNode$XmlParam._accept(ASTNode.java:247)
                            // jsignalml.JavaClassGen.visit(JavaClassGen.java:1)
                            // jsignalml.JavaClassGen.visit(JavaClassGen.java:487)
                            // jsignalml.JavaClassGen.readParamFunction(JavaClassGen.java:641)
                            // node.type=TypeString
                            // --> nodetype=TypeString
                            // xpathPattern=(calibration_gain_expr)
                            // xpathEvaluationType=(node-content-text)
                            // xpathAttributeName=(null)
                            TypeString xpathPattern = get_calibration_gain_expr().get();
                            XmlBuffer xmlBuf = xmlBuffer();
                            TypeString _t = null;
                            TypeString value = xmlBuf.read(xpathPattern, "node-content-text", _t);
                            return value;
                        }
            ...
            extends Param<TypeInt>
        {
            ...
            protected TypeInt _get() {
                ...
                // xpathEvaluationType=(node-content-int)
                // xpathAttributeName=(null)
                TypeString xpathPattern = new TypeString("/rs:rawSignal/rs:blocksPerPage");
                XmlBuffer xmlBuf = xmlBuffer();
                TypeInt _t = null;
                TypeInt value = xmlBuf.read(xpathPattern, "node-content-int", _t);
                return value;
            }
            ...
            public Long get_p() {
                ...
                // jsignalml.JavaClassGen.visit(JavaClassGen.java:1)
                // jsignalml.JavaClassGen.visit(JavaClassGen.java:487)
                // jsignalml.JavaClassGen.readParamFunction(JavaClassGen.java:666)
                // jsignalml.JavaClassGen.getMethod_p(JavaClassGen.java:766)
                // jsignalml.JavaClassGen._cacheMethod(JavaClassGen.java:993)
                if (get_p == null) {
                    get_p = this.get().safeLongValue();
            ...
            extends Param<TypeFloat>
        {
            ...
            protected TypeFloat _get() {
                ...
                // xpathEvaluationType=(node-content-float)
                // xpathAttributeName=(null)
                TypeString xpathPattern = new TypeString("/rs:rawSignal/rs:calibration");
                XmlBuffer xmlBuf = xmlBuffer();
                TypeFloat _t = null;
                TypeFloat value = xmlBuf.read(xpathPattern, "node-content-float", _t);
                return value;
            }
