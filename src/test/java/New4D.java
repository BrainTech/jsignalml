    ...
    extends Signalml
{
        ...
        extends Signalml.FileClass
    {
        ...
        New4D.File_main._param_channel_name get_channel_name = null;
        New4D.File_main._param_channel_type_name get_channel_type_name = null;
        ...
        public New4D.File_main._param_channel_name get_channel_name() {
            // jsignalml.ASTNode$ExprParam._accept(ASTNode.java:319)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:39)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:457)
            // jsignalml.JavaClassGen.paramClass(JavaClassGen.java:514)
            ...
            if (get_channel_name == null) {
                get_channel_name = new New4D.File_main._param_channel_name();
            }
            return get_channel_name;
        }

        public New4D.File_main._param_channel_type_name get_channel_type_name() {
            // jsignalml.ASTNode$ExprParam._accept(ASTNode.java:319)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:39)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:457)
            // jsignalml.JavaClassGen.paramClass(JavaClassGen.java:514)
            ...
            if (get_channel_type_name == null) {
                get_channel_type_name = new New4D.File_main._param_channel_type_name();
            }
