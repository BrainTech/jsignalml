    ...
    extends Signalml
{
    ...
    New4DAscii.header get_header = null;
    ...
    public void createParams() {
        ...
        log.debug("New4DAscii.createParams()");
        {
            ...
            // jsignalml.JavaClassGen.access$000(JavaClassGen.java:39)
            New4DAscii.header obj = get_header();
            register("header", obj);
            obj.createParams();
        }
        {
    ...
    public New4DAscii.header get_header() {
        // jsignalml.ASTNode$Header._accept(ASTNode.java:690)
        // jsignalml.JavaClassGen.visit(JavaClassGen.java:39)
        // jsignalml.JavaClassGen.visit(JavaClassGen.java:1121)
        ...
        if (get_header == null) {
            get_header = new New4DAscii.header();
        }
        return get_header;
    }
        ...
        extends Header
    {
        ...
        New4DAscii.header._param_format_id get_format_id = null;
        New4DAscii.header._param_codec_id get_codec_id = null;
        ...
        public New4DAscii.header._param_format_id get_format_id() {
            // jsignalml.ASTNode$FormatID._accept(ASTNode.java:724)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:39)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:632)
            ...
            if (get_format_id == null) {
                get_format_id = new New4DAscii.header._param_format_id();
            }
            return get_format_id;
        }

        public New4DAscii.header._param_codec_id get_codec_id() {
            // jsignalml.ASTNode$CodecID._accept(ASTNode.java:756)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:39)
            // jsignalml.JavaClassGen.visit(JavaClassGen.java:669)
            ...
            if (get_codec_id == null) {
                get_codec_id = new New4DAscii.header._param_codec_id();
            }
            return get_codec_id;
        }
            ...
            extends FormatId
        {
            ...
            public Type name = new TypeString("New 4D ascii format");
